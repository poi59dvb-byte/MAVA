...
<div class="hud" id="hud">
  <div class="row"><span id="mode"></span><span id="lap"></span><span id="time"></span></div>
  ...
  <div class="row"><button id="restartBtn">Reiniciar</button><button id="pauseBtn">Pause</button></div>
</div>`;
