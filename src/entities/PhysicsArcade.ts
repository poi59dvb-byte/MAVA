...
export class PhysicsArcade {
  step(car: CarState, input: ControlProfile, dtRaw: number, stats: CarStats, track: TrackPhysicsInfo): CarState {
    ...
    const turn = input.steer * stats.turnRate * track.sensitivity * steerGain * (1 - speedFactor * steerLoss);
